...
// The frontend URL as seen in the browser (from the image)
const FRONTEND_URL = 'https://cyber-suite-all-in-one-cybersecurity-toolkit-mtlw9dsjpx.vercel.app';
...
async function runTests() {
  console.log('Testing backend with frontend URL:', FRONTEND_URL);
