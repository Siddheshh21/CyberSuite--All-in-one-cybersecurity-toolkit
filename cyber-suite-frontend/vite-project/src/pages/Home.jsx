  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center text-white overflow-hidden bg-[#0F2027]">
      ...
      <div className="text-center max-w-4xl px-6 animate-fadeIn">
        <h1 className="text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-[#10ff8d] to-[#00faff] drop-shadow-lg mb-4">
        ...
        <h2 className="text-2xl font-bold text-[#00faff] mb-4">
        ...
        <p className="mt-4 text-lg text-[#10ff8d]/90 opacity-0 animate-fadeIn" style={{ animationDelay: '4s', animationFillMode: 'forwards' }}>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link
            ...
            className="px-6 py-3 bg-[#10ff8d] text-gray-900 rounded-lg font-semibold shadow-lg hover:scale-105 transition-all duration-300 hover:bg-[#00ff99]"
          >
            Try Password Analyzer
          </Link>
          <Link
            to="/vulnerability-scan"
            className="px-6 py-3 bg-gradient-to-r from-[#0F2027] to-[#2C5364] text-white rounded-lg font-semibold shadow-lg hover:scale-105 transition-all duration-300 border border-[#10ff8d]/30 hover:border-[#10ff8d]/60"
          >
            Run Vulnerability Scan
          </Link>
          <Link
            to="/breach-checker"
            className="px-6 py-3 border border-[#10ff8d]/30 text-white rounded-lg hover:bg-[#2C5364]/30 transition-all duration-300 hover:border-[#10ff8d]/60"
          >
      ...
      <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl px-6">
        {[
          ...
          <div
            key={index}
            className="p-6 bg-[#2C5364]/30 rounded-lg shadow-lg backdrop-blur-sm hover:scale-105 hover:bg-[#2C5364]/40 transition-all duration-300 flex flex-col items-center text-center border border-white/10"
          >
